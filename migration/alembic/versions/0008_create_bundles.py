...
def upgrade():
    ...
    op.create_index(
        "idx_bundles_partition_bundle_code",
        "bundles",
        ["partition_key", "bundle_code"],
    )
    op.create_index(
        "idx_bundles_partition_updated_at",
        "bundles",
...
def downgrade():
    op.drop_index("idx_bundles_partition_updated_at", table_name="bundles")
    op.drop_index("idx_bundles_partition_bundle_code", table_name="bundles")
